...
//        public async Task<ClientWebSocket> InitLiveRoom(string url, int roomId)
//        {
//            // 创建 WebSocket 客户端
//            try
//            {
...
//                Task.Run(() => SendHeartBeatPackage(client));
//                Task.Run(() => ReceiveWebSocket(client));

//                return client;
//            }
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"Failed to connect to WebSocket server: {ex.Message}");
//                if (client != null)
//                {
...
//        public async Task SendHeartBeatPackage(ClientWebSocket client)
//        {
//            // 每30秒发送一次心跳包
...
//        public async Task ReceiveWebSocket(ClientWebSocket client)
//        {
...
//                    {
//                        Debug.WriteLine("WebSocket connection closed by server.");
//                        break;
//                    }
...
//                catch (Exception ex)
//                {
//                    Debug.WriteLine($"Failed to receive message from WebSocket server: {ex.Message}");
//                    break;
//                }
//            }
//        }

//        private void ReceivedMessageHandler(byte[] message)
//        {
//            int totalLength = 0;
...
//                // 输出数据包信息
//                Debug.WriteLine($"Received packet: totalLength={totalLength}, headerLength={headerLength}, version={version}, opcode={opcode}, sequence={sequence}, data={BitConverter.ToString(data)}");
//            }
//        }


//        private async Task ConnectWebSocket(ClientWebSocket client, Uri uri)
//        {
//            int retryCount = 0;
//            while (client.State != WebSocketState.Open)
//            {
...
//                    if (retryCount > 3)
//                    {
//                        Debug.WriteLine("Failed to connect to WebSocket server after 3 retries. Exiting...");
//                        return;
//                    }
...
//        private async Task SendPacket(ClientWebSocket client, byte[] data, Opcode opcode)
//        {
//            // 计算数据包总长度
...
//            catch (Exception ex)
//            {
//                Debug.WriteLine($"Failed to send packet: {ex.Message}");
//            }
//        }
//    }
//}
